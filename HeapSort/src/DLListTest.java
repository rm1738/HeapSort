...
public class DLListTest extends TestCase {
    ...
    /**
     * Tests iterating through the list.
     */
    public void testIterator() {
        ...
        assertEquals("string1", iter.next());
        assertEquals(iter.next(), "string2");
    }


    /**
     * Tests iterating when the list is empty.
     */
    ...
    /**
     * Tests the iterators exceptions.
     */
    ...
    /**
     * Tests reverse iterating through the list.
     */
    public void testReverseIterator() {
        ...
        assertTrue(iter.hasNext());
        assertEquals("string4", iter.next());
        assertEquals(iter.next(), "string3");
    }
